...
const SENDANNOUNCEMENTSMAIL = async (
	userName,
	date,
	department,
	notes,
	...
	const options = {
		...
		subject: `New Announcement for ${department}`, // Subject line
		text: message,
		attachments: [
			{
				filename: "new-announcement.pdf",
				path: file_url,
			},
		],
		html: `
								...
								<td width="100%">
									...
									<tr>
											<td width="100%" style="font-size: 14px; color: #8d9499; text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; line-height: 26px; vertical-align: top; font-weight: 400;" class="fullCenter">
											  <strong><span style="color: rgb(0, 0, 0);" >Dear ${userName}</span></strong><br><br><br><span style="color: rgb(0, 0, 0);" >A new announcement has been published for ${department}, kindly view attachement or login your account to view</span><span style="color: rgb(0, 0, 0);" >.</span></p><p>Announcement Details</p><p><strong><span style="color: rgb(0, 0, 0);" >Department:</span></strong>  ${department}<br><strong><span style="color: rgb(0, 0, 0);" >Date Added:</span></strong> ${date}<br><strong><span style="color: rgb(0, 0, 0);" >Notes:</span></strong> ${notes}<br>
											</td>
										  </tr>
												...
												<span class="featuredHolder"><span class="featuredHolder"><table border="0" cellpadding="0" cellspacing="0" align="left" class="buttonScale">
													<tbody><tr>
														<td width="100%" align="center" height="38" bgcolor="#fc505a" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; padding-left: 25px; padding-right: 25px; font-weight: 600; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; color: #ffffff; font-size: 13px;">
															<multiline><a href="https://app.labpartners.co.zw/announcements" style="color: #ffffff; font-size: 13px; text-decoration: none; line-height: 13px; width: 100%;">View Business Manual</a></multiline>
														</td>
													</tr>
...
module.exports = SENDANNOUNCEMENTSMAIL;
