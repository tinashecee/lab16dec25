...
const SENDBUSINESSMANUALADDEDMAIL = async (
	userName,
	dateAdded,
	effectiveDate,
	version,
	...
	const message = "New Business Manual";
	const options = {
		from: "Lab Partners <mochonam19@gmail.com>", // sender address
		to: email, // receiver email
		subject: `New Business Manual added for ${department} department`, // Subject line
		text: message,
		attachments: [
			{
				filename: "new-business-manual.pdf",
				path: file_url,
			},
		],
		html: `
...
module.exports = SENDBUSINESSMANUALADDEDMAIL;
