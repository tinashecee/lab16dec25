...
const SENDBUSINESSMANUALUPDATEDMAIL = async (
	userName,
	dateAdded,
	effectiveDate,
	version,
	...
	const message = "Updated Business Manual";
	const options = {
		from: "Lab Partners <mochonam19@gmail.com>", // sender address
		to: email, // receiver email
		subject: `Updated Business Manual added for ${department} department`, // Subject line
		text: message,
		attachments: [
			{
				filename: "updated-business-manual.pdf",
				path: file_url,
			},
		],
		html: `
								...
								<td width="100%">
									...
									<tr>
											<td width="100%" style="font-size: 14px; color: #8d9499; text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; line-height: 26px; vertical-align: top; font-weight: 400;" class="fullCenter">
											  <strong><span style="color: rgb(0, 0, 0);" >Dear ${userName}</span></strong><br><br><br><span style="color: rgb(0, 0, 0);" >A business manual has been updated for your department, kindly view attachement or login your account to view</span><span style="color: rgb(0, 0, 0);" >.</span></p><p>Business Manual Details</p><p><strong><span style="color: rgb(0, 0, 0);" >Department:</span></strong>  ${department}<br><strong><span style="color: rgb(0, 0, 0);" >Date Added:</span></strong> ${dateAdded}<br><strong><span style="color: rgb(0, 0, 0);" >Effective Date:</span></strong> ${effectiveDate}<br><strong><span style="color: rgb(0, 0, 0);" >Version:</span></strong> ${version}<br><strong><span style="color: rgb(0, 0, 0);" >Last Updated:</span></strong> ${lastUpdated}<br><strong><span style="color: rgb(0, 0, 0);" >Notes:</span></strong> ${notes}<br>
											</td>
										  </tr>
												...
												<span class="featuredHolder"><span class="featuredHolder"><table border="0" cellpadding="0" cellspacing="0" align="left" class="buttonScale">
													<tbody><tr>
														<td width="100%" align="center" height="38" bgcolor="#fc505a" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; padding-left: 25px; padding-right: 25px; font-weight: 600; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; color: #ffffff; font-size: 13px;">
															<multiline><a href="https://app.labpartners.co.zw/business-manual" style="color: #ffffff; font-size: 13px; text-decoration: none; line-height: 13px; width: 100%;">View Business Manual</a></multiline>
														</td>
													</tr>
...
<!--—EndModule--></tbody></table><!--—EndPremade-->
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0" align="left" style="text-align: center;" class="fullCenter">
							...
							<tr>
								<td width="100%" style="text-align: center; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 13px; color: #8d9499; font-weight: 400;" class="fullCenter">
									<span style="color: #ffffff;" ><br data-mce-bogus="1"></span></p><p><span style="color: #ffffff;" >© 2023 All rights Reserved - Powered by <strong><a href="https://soxfort.com" >Soxfort Solutions</a> </strong>| Intuitive Innovation</span>
								</td>
							</tr>
							<tr>
...
module.exports = SENDBUSINESSMANUALUPDATEDMAIL;
