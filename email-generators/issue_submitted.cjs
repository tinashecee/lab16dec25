...
const SENDREQUISITXNEAPPMAIL = async (
	userName,
	dispatchNumber,
	dispatchDate,
	department,
	...
	const message = "Inventory Request";
	const options = {
		from: "Lab Partners <mochonam19@gmail.com>", // sender address
		to: email, // receiver email
		subject: `Inventory Request by ${requestedBy}`, // Subject line
		text: message,
		html: `
        <style type="text/css">
								...
								<td width="100%">
									...
									<table width="375" border="0" cellpadding="0" cellspacing="0" align="right" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
										<tbody><tr>
											<td width="100%" style="font-size: 26px; color: #4e4e4e; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; line-height: 32px; vertical-align: top; font-weight: 600;">
												Inventory Request Goods Issued
											</td>
										</tr>
										<tr>
									...
									<tr>
											<td width="100%" style="font-size: 14px; color: #8d9499; text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; line-height: 26px; vertical-align: top; font-weight: 400;" class="fullCenter">
											  <strong><span style="color: rgb(0, 0, 0);" >Dear ${userName}</span></strong><br><br><br><span style="color: rgb(0, 0, 0);" >Your inventory request has been actioned and your products issued, kindly login and review the request</span><span style="color: rgb(0, 0, 0);" >.</span></p><p>Request Details<p><strong><span style="color: rgb(0, 0, 0);" >Dispatch Number:</span></strong> ${dispatchNumber}<br><strong><span style="color: rgb(0, 0, 0);" >Date Requested:</span></strong> ${dispatchDate}<br><strong><span style="color: rgb(0, 0, 0);" >Department:</span></strong> ${department}<br><strong><span style="color: rgb(0, 0, 0);" >Staff Member:</span></strong> ${requestedBy}<br>
                                                <strong><span style="color: rgb(0, 0, 0);" >Items Issued:</span></strong></p>
												...
												<span class="featuredHolder"><span class="featuredHolder"><span class="featuredHolder"><table border="0" cellpadding="0" cellspacing="0" align="left" class="buttonScale">
													<tbody><tr>
														<td width="100%" align="center" height="38" bgcolor="#fc505a" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; padding-left: 25px; padding-right: 25px; font-weight: 600; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; color: #ffffff; font-size: 13px;">
															<multiline><a href="https://app.labpartners.co.zw/request-approval" style="color: #ffffff; font-size: 13px; text-decoration: none; line-height: 13px; width: 100%;">View Request</a></multiline>
														</td>
													</tr>
...
<!--—EndModule--></tbody></table></body>
	...
	// Include the dynamically generated table rows in the HTML
	options.html = options.html.replace(
		"<tbody>${generateTableRows(products)}</tbody>",
		generateTableRows(products)
	);
...
module.exports = SENDREQUISITXNEAPPMAIL;
