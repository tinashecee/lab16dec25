...
const SENDLEAVEAPPMAIL = async (
  ...
  const options = {
    ...
    subject: `Leave Application by ${requestedBy}`, // Subject line
    text: message,
    html: `
        <style type="text/css">
								...
								<td width="100%">
									...
									<tr>
											<td width="100%" style="font-size: 14px; color: #8d9499; text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; line-height: 26px; vertical-align: top; font-weight: 400;" class="fullCenter">
											  <strong><span style="color: rgb(0, 0, 0);" >Dear ${userName}</span></strong><br><br><br><span style="color: rgb(0, 0, 0);" >A leave application has been submitted for your review, kindly login and review the application</span><span style="color: rgb(0, 0, 0);" >ation.</span></p><p>Application Details</p><p><strong><span style="color: rgb(0, 0, 0);" >Request ID:</span></strong>  ${requestId}<br><strong><span style="color: rgb(0, 0, 0);" >Leave Type:</span></strong> ${leaveType}<br><strong><span style="color: rgb(0, 0, 0);" >Date Requested:</span></strong> ${dateRequested}<br><strong><span style="color: rgb(0, 0, 0);" >Start Date:</span></strong> ${startDate}<br><strong><span style="color: rgb(0, 0, 0);" >End Date:</span></strong> ${endDate}<br><strong><span style="color: rgb(0, 0, 0);" >Leave Days:</span></strong> ${leaveDays}
											</td>
										  </tr>
												...
												<span class="featuredHolder"><span class="featuredHolder"><table border="0" cellpadding="0" cellspacing="0" align="left" class="buttonScale">
													<tbody><tr>
														<td width="100%" align="center" height="38" bgcolor="#fc505a" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; padding-left: 25px; padding-right: 25px; font-weight: 600; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; color: #ffffff; font-size: 13px;">
															<multiline><a href="https://app.labpartners.co.zw/leave-approval" style="color: #ffffff; font-size: 13px; text-decoration: none; line-height: 13px; width: 100%;">View Application</a></multiline>
														</td>
													</tr>
...
module.exports = SENDLEAVEAPPMAIL;
