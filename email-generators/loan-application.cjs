...
const SENDLOANAPPMAIL = async (
  ...
  const options = {
    ...
    subject: `Loan Application by ${requestedBy}`, // Subject line
    text: message,
    html: `
        <style type="text/css">
								...
								<td width="100%">
									...
									<tr>
											<td width="100%" style="font-size: 14px; color: #8d9499; text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; line-height: 26px; vertical-align: top; font-weight: 400;" class="fullCenter">
											  <strong><span style="color: rgb(0, 0, 0);" >Dear ${userName}</span></strong><br><br><br><span style="color: rgb(0, 0, 0);" >A loan application has been submitted for your review, kindly login and review the application</span><span style="color: rgb(0, 0, 0);" >.</span></p><p>Application Details</p><p><strong><span style="color: rgb(0, 0, 0);" >Loan Request ID:</span></strong>  ${requestId}<br><strong><span style="color: rgb(0, 0, 0);" >Request By:</span></strong> ${requestedBy}<br><strong><span style="color: rgb(0, 0, 0);" >Date Requested:</span></strong> ${dateRequested}<br><strong><span style="color: rgb(0, 0, 0);" >Amount:</span></strong> ${amount}<br><strong><span style="color: rgb(0, 0, 0);" >Purpose:</span></strong> ${purpose}<br><strong><span style="color: rgb(0, 0, 0);" >Repayment Period:</span></strong> ${loanRepaymentTimeline}
											</td>
										  </tr>
												...
												<span class="featuredHolder"><span class="featuredHolder"><table border="0" cellpadding="0" cellspacing="0" align="left" class="buttonScale">
													<tbody><tr>
														<td width="100%" align="center" height="38" bgcolor="#fc505a" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; padding-left: 25px; padding-right: 25px; font-weight: 600; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; color: #ffffff; font-size: 13px;">
															<multiline><a href="https://app.labpartners.co.zw/loan-approval" style="color: #ffffff; font-size: 13px; text-decoration: none; line-height: 13px; width: 100%;">View Application</a></multiline>
														</td>
													</tr>
...
module.exports = SENDLOANAPPMAIL;
