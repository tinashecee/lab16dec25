...
const SENDLOANAPPRESEMAIL = async (
	userName,
	requestId,
	amount,
	dateRequested,
	...
	const message = "Your Loan Application Response";
	const options = {
		from: "Lab Partners <mochonam19@gmail.com>", // sender address
		to: email, // receiver email
		subject: `Your loan application has been ${status}`, // Subject line
		text: message,
		html: `
        <style type="text/css">
									...
									<table width="375" border="0" cellpadding="0" cellspacing="0" align="right" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
										<tbody><tr>
											<td width="100%" style="font-size: 26px; color: #4e4e4e; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; line-height: 32px; vertical-align: top; font-weight: 600;">
												<span style="color: rgb(0, 0, 0);" >Loan Application <span style="font-family: 'Open Sans';" >Confirmation| ${status}</span></span>
											</td>
										</tr>
										<tr>
										...
										<tr>
											<td width="100%" style="font-size: 14px; color: #8d9499; text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; line-height: 26px; vertical-align: top; font-weight: 400;" class="fullCenter">
											  ...
											  <p><em><span style="color: rgb(0, 0, 0); font-size: 12pt;" >Your loan application with the following details has been ${status}:</span></em></p>
											 <p><strong><span style="color: rgb(0, 0, 0);" >Loan Request ID:</span></strong>  ${requestId}<br><strong><span style="color: rgb(0, 0, 0);" >Date Requested:</span></strong> ${dateRequested}<br><strong><span style="color: rgb(0, 0, 0);" >Amount:</span></strong> ${amount}<br><strong><span style="color: rgb(0, 0, 0);" >Purpose:</span></strong> ${purpose}<br><strong><span style="color: rgb(0, 0, 0);" >Repayment Period:</span></strong> ${loanRepaymentTimeline}<p><span style="font-size: 12pt;" ><strong>
												...
												<span class="featuredHolder"><table border="0" cellpadding="0" cellspacing="0" align="left" class="buttonScale repeaterFull">
													<tbody><tr>
														<td width="100%" align="center" height="38" bgcolor="#fc505a" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; padding-left: 25px; padding-right: 25px; font-weight: 600; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; color: #ffffff; font-size: 13px;">
															<multiline><a href="https://app.labpartners.co.zw/loan-request" style="color: #ffffff; font-size: 13px; text-decoration: none; line-height: 13px; width: 100%;">View Application</a></multiline>
														</td>
													</tr>
												</tbody></table></span>
...
module.exports = SENDLOANAPPRESEMAIL;
