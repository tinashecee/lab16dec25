...
const SENDREQUISITXNEAPPRESMAIL = async (
	userName,
	dispatchNumber,
	dispatchDate,
	department,
	...
	const message = "Your Inventory Request Response";
	const options = {
		from: "Lab Partners <mochonam19@gmail.com>", // sender address
		to: email, // receiver email
		subject: `Your inventory request has been ${status}`, // Subject line
		text: message,
		html: `
        <style type="text/css">
								...
								<td width="100%">
									...
									<tr>
											<td width="100%" style="font-size: 14px; color: #8d9499; text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; line-height: 26px; vertical-align: top; font-weight: 400;" class="fullCenter">
											  <strong><span style="color: rgb(0, 0, 0);" >Dear ${userName}</span></strong><br><br><br><span style="color: rgb(0, 0, 0);" >Your inventory request has been <strong>${status}</strong> with the following comments:</span><span style="color: rgb(0, 0, 0);" ><em>${comments}</em></span></p><p>Request Details<p><strong><span style="color: rgb(0, 0, 0);" >Dispatch Number:</span></strong> ${dispatchNumber}<br><strong><span style="color: rgb(0, 0, 0);" >Date Requested:</span></strong> ${dispatchDate}<br><strong><span style="color: rgb(0, 0, 0);" >Department:</span></strong> ${department}<br><strong><span style="color: rgb(0, 0, 0);" >Staff Member:</span></strong> ${requestedBy}<br>
												...
												<span class="featuredHolder"><span class="featuredHolder"><span class="featuredHolder"><table border="0" cellpadding="0" cellspacing="0" align="left" class="buttonScale">
													<tbody><tr>
														<td width="100%" align="center" height="38" bgcolor="#fc505a" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; padding-left: 25px; padding-right: 25px; font-weight: 600; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; color: #ffffff; font-size: 13px;">
															<multiline><a href="https://app.labpartners.co.zw/requisitxn" style="color: #ffffff; font-size: 13px; text-decoration: none; line-height: 13px; width: 100%;">View Response</a></multiline>
														</td>
													</tr>
...
module.exports = SENDREQUISITXNEAPPRESMAIL;
