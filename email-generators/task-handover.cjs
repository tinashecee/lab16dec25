...
const SENDHANDOVERMAIL = async (
	...
	const message = "Task Handover";
	const options = {
		from: "Lab Partners <mochonam19@gmail.com>", // sender address
		to: email, // receiver email
		subject: `A New Task has been Assigned to you by ${assigned_by}`, // Subject line
		text: message,
		html: `
        <style type="text/css">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full"></table><table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full"></table><table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full" style="pointer-events: auto; top: 0px; left: 0px;"></table><table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full"><table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full">
	<tbody ><tr>
								...
								<td width="100%">
									...
									<tr>
											<td width="100%" style="font-size: 14px; color: #8d9499; text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; line-height: 26px; vertical-align: top; font-weight: 400;" class="fullCenter">
											  <strong><span style="color: rgb(0, 0, 0);" >Dear ${assigned_to}</span></strong><br><br><br><span style="color: rgb(0, 0, 0);" >A new task has been assigned to you by  <strong>${assigned_by}</strong></span><span style="color: rgb(0, 0, 0);" >.</span></p><p>Task Details<p><strong><span style="color: rgb(0, 0, 0);" >Handover ID:</span></strong> ${handover_id}</p><br><strong><span style="color: rgb(0, 0, 0);" >Assigned By:</span></strong> ${assigned_by}<br><strong><span style="color: rgb(0, 0, 0);" >Date Assigned:</span></strong> ${date}<br><strong><span style="color: rgb(0, 0, 0);" >Due Date:</span></strong> ${due_date}<br><strong><span style="color: rgb(0, 0, 0);" >Task Name:</span></strong> ${task_name}<br><strong><span style="color: rgb(0, 0, 0);" >Task Description:</span></strong> ${task_desc}<br>
                                             
                                                
											</td>
										  </tr>
											<tr><td width="100%" height="45"></td>
										</tr>
										<!-- Button Left -->
										<tr>
											<td width="100%" class="buttonScale" align="left">
												
												<span class="featuredHolder"><span class="featuredHolder"><span class="featuredHolder"><table border="0" cellpadding="0" cellspacing="0" align="left" class="buttonScale">
													<tbody><tr>
														<td width="100%" align="center" height="38" bgcolor="#fc505a" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; padding-left: 25px; padding-right: 25px; font-weight: 600; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; color: #ffffff; font-size: 13px;">
															<multiline><a href="https://app.labpartners.co.zw/task-handover" style="color: #ffffff; font-size: 13px; text-decoration: none; line-height: 13px; width: 100%;">View Handover</a></multiline>
														</td>
													</tr>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0" align="left" style="text-align: center;" class="fullCenter">
							...
							<tr>
								<td width="100%" style="text-align: center; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 13px; color: #8d9499; font-weight: 400;" class="fullCenter">
									<span style="color: #ffffff;">© 2023 All rights Reserved - Powered by <strong><a href="https://soxfort.com">Soxfort Solutions</a> </strong>| Intuitive Innovation</span>
								</td>
							</tr>
							<tr>
...
module.exports = SENDHANDOVERMAIL;
