...
import DriverHandoverModal from "../components/inventory/DriverHandoverModal";
...
export default function DriverHandover() {
  ...
  const fetchRequisition = async () => {
    try {
      ...
      // Check if requisition is in the correct status for driver handover
      if (requisitionData.status !== "Issued") {
        setError("This requisition is not ready for driver handover. Current status: " + requisitionData.status);
        return;
      }
